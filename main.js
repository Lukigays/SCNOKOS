...
return {
conversation: 'WhatsApp Bot By Rizky - Hosting.'
}}
}
...
let teksnotif = `*Rizky - Hosting*
Connected To ${Reza.user.id.split(":")[0]}`
Reza.sendMessage("6283165503013@s.whatsapp.net", {text: teksnotif})
...
require("./RizkyHosting")(Reza, m, store)
} catch (err) {
console.log(err)
}
})
